...
*/
function TodoList() {
  // To do list 상태관리 -> react hook useState
    ...
    <div className="todo-list">
      ...
      <div className="add-todo">
        <input
          ...
          // addTodo 가 아니라 addTodo() 로 명시한 이유는 엔터키 이벤트 발생시에 바로 호출 즉 실행되어 todo를 추가하기 위해 즉 구현부 내에서는 실행을 해야 하므로 반드시 ()를 명시해야 됨
          // keydown 이벤트 발생시 실행될 화살표 함수 arrow function 을 등록 binding
      ...
      <ul className="todo-items">
        {todos.map((todo) => (
          ...
          >
            ...
            {/* 
                삭제 버튼이 클릭되면 (클릭이벤트 발생시) 실행될 화살표 함수를 등록 
